...
public class PlanJDBCDAO implements PlanProduct_interface {
	...
	public void insert(PlanProduct_interface planProduct) {
		...
		try {
			...
			pstmt = con.prepareStatement(INSERT_PLAN);
	...
	@Override
	public void update(PlanVO empVO) {
	...
	@Override
	public PlanVO findByPrimaryKey(Integer empno) {
	...
	public static void main(String[] args) {
		...
		// 查詢
		PlanVO empVO3 = dao.findByPrimaryKey(7001);
